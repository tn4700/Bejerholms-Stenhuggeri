...
//            try {
//               Timestamp levering = Utility.getNewTimestamp(""+(Integer)jComboBox_levering_dag.getSelectedItem()+""+(Integer)jComboBox_levering_måned.getSelectedItem()+""+((Integer)jComboBox_year_leveringsdato.getSelectedItem())+""); 
