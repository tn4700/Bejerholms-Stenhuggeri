...
public class Panel_LagerLinje extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(490, 38));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        vareNavnLabel.setText("jLabel1");
        jPanel1.add(vareNavnLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));

        vareDimensionLabel.setText("jLabel1");
        jPanel1.add(vareDimensionLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, -1, -1));

        varePrisLabel.setText("jLabel1");
        jPanel1.add(varePrisLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, -1, -1));
